...
void test_singly_linked_list_insert(void) {
    ...
    CU_ASSERT_EQUAL(*((int *)list->head->data), 0);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 1);
    ...
    CU_ASSERT_EQUAL(*((int *)list->head->data), 0);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 1);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->data), 2);
    ...
    CU_ASSERT_EQUAL(*((int *)list->head->data), 3);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 0);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->data), 1);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->next->data), 2);
    ...
    CU_ASSERT_EQUAL(*((int *)list->head->data), 3);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 0);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->data), 4);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->next->data), 1);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->next->next->data), 2);
...
void test_singly_linked_list_remove(void) {
    ...
    CU_ASSERT_EQUAL(list->size, 4);
    CU_ASSERT_EQUAL(*((int *)list->head->data), 1);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 2);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->data), 3);
    CU_ASSERT_EQUAL(*((int *)list->head->next->next->next->data), 4);
    CU_ASSERT_EQUAL(list->head->next->next->next->next, NULL);
    ...
    CU_ASSERT_EQUAL(list->size, 2);
    CU_ASSERT_EQUAL(*((int *)list->head->data), 1);
    CU_ASSERT_EQUAL(*((int *)list->head->next->data), 3);
    CU_ASSERT_EQUAL(list->head->next->next, NULL);
    CU_ASSERT_NOT_EQUAL(dsc_singly_linked_list_remove(list, 0), 0);
    CU_ASSERT_EQUAL(list->size, 1);
    CU_ASSERT_EQUAL(*((int *)list->head->data), 3);
