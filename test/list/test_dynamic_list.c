...
void test_dynamic_list_remove(void) {
    ...
    CU_ASSERT_EQUAL(*((int *)list->data[0]), 1);
    CU_ASSERT_EQUAL(*((int *)list->data[1]), 2);
    CU_ASSERT_EQUAL(*((int *)list->data[2]), 3);
    CU_ASSERT_EQUAL(*((int *)list->data[3]), 4);
    ...
    CU_ASSERT_EQUAL(list->size, 2);
    CU_ASSERT_EQUAL(*((int *)list->data[0]), 1);
    CU_ASSERT_EQUAL(*((int *)list->data[1]), 3);
